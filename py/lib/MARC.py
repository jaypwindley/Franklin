...
class MARC_tag( object ):
    ...
    def parse_canonical_string( self, s ):
        ...
        MARC_fieldlist.fld_delim = values[0]
        ...
        # the subfield code.
        #
        subfields = values.split( MARC_fieldlist.fld_delim )
...
class MARC_record( object ):

    # Normally defers to MARC_tag.fld_delim but for output's sake
    # etc. this takes precedence.
    #
    fld_delim = '|'
    ...
    def parse_canonical_string( self, s ):
        ...
        for line in lines:
            ...
            # Regular tag
            self.tags.append( MARC_tag( str = line, seq = seq ) )
    ...
    def strip_900s( self ):
        """
        Remove all 9xx tags.  These are internal Library of Congress
        tags.
        """
