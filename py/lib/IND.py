...
fromk kwargable import kwargable
...
class IND( kwargable ):
    ...
    def __init__( self, **kwargs ):
        ...
        """
        kwargable constructor pattern.  Set the defaults for the canonical fields and then override
        them as needed from the constructor arguments.
        """
        self.ID           = None
        self.name         = ''
        self.description  = ''
